...
class AddressForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        shipping_address_query_set = Address.objects.filter(
            user=user,
            address_type='S'
        )
        billing_address_query_set = Address.objects.filter(
            user=user,
            address_type='B'
        )

        self.fields['selected_shipping_address'].queryset = shipping_address_query_set
        self.fields['selected_billing_address'].queryset = billing_address_query_set
